...
def datetime_with_tz(dt, fmt=DATETIME_FMT, tz=None, use_dateparser=False, dp_kwargs=None):
    """
    ...
    :param bool use_dateparser: Use `dateparser <https://dateparser.readthedocs.io/en/latest/>`_ to parse the given
